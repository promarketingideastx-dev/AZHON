  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <div className="mt-6 w-full">
        <button type="button" disabled className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium py-3 px-4 rounded-full transition-colors disabled:opacity-50">
